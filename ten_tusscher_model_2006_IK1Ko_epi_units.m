%===============================================================================
% CellML file:   D:\Desktop\Models\ten_tusscher_model_2006_IK1Ko_epi_units.cellml
% CellML model:  tentusscher_panfilov_2006_epi_cell
% Date and time: 17/06/2015 at 23:34:06
%-------------------------------------------------------------------------------
...
function dY = ten_tusscher_model_2006_IK1Ko_epi_units(time, Y)

%-------------------------------------------------------------------------------
% Initial conditions
%-------------------------------------------------------------------------------

% Y = [3.373e-5, 0.9755, 0.9953, 0.7888, 3.64, 0.000126, 0.00036, 0.9073, 0.7444, 0.7045, 0.00172, -85.23, 136.89, 0.00621, 0.4712, 0.0095, 8.604, 2.42e-8, 0.999998];
...
dY(12, 1) = -1.0/1.0*(i_K1+i_to+i_Kr+i_Ks+i_CaL+i_NaK+i_Na+i_b_Na+i_NaCa+i_b_Ca+i_p_K+i_p_Ca+i_Stim);
...
s_inf = 1.0/(1.0+exp((Y(12)+20.0)/5.0));
tau_s = 85.0*exp(-(Y(12)+45.0)^2.0/320.0)+5.0/(1.0+exp((Y(12)-20.0)/5.0))+3.0;
